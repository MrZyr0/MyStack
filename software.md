...
|                                | Windows                                                                                               | Linux                                                                                                | Mac OS                                                                                                              |
| ------------------------------ | :---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| **Git GUI**                    | [Fork](https://git-fork.com)                                                                          | [GitAhead](https://gitahead.github.io/gitahead.com/)                                                 | [Fork](https://git-fork.com)                                                                                                                             |
...
| **Termminal**                  | [The new terminal](https://www.microsoft.com/p/windows-terminal/9n0dx20hk701)                         | Intergrated terminal                                                                                 | [iTerm2](https://iterm2.com) with [ayu color scheme](https://iterm2colorschemes.com)                                |
| **ZSH**                        | [Oh My ZSH](https://ohmyz.sh) and [Powerlevel10k theme](https://github.com/romkatv/powerlevel10k)     | [Oh My ZSH](https://ohmyz.sh) and [Powerlevel10k theme](https://github.com/romkatv/powerlevel10k)    | [Oh My ZSH](https://ohmyz.sh) and [Powerlevel10k theme](https://github.com/romkatv/powerlevel10k)                   |
